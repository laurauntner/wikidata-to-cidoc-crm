...
| ![Modules overview](https://github.com/laurauntner/wikidata-to-cidoc-crm/blob/main/docs/meta.png?raw=true) |
|:--:| 
| Modules overview |
...
| ![Workflow overview](https://github.com/laurauntner/wikidata-to-cidoc-crm/blob/main/docs/workflow_overview.png?raw=true) |
|:--:| 
| Workflow overview |
...
- `F3_Manifestation` (publications of expressions) and `F30_Manifestation_Creation` with:
  - `E21_Person` (editors, derived from `wdt:P98`)
...
- OntoPoetry/POSTDATA ([core](https://raw.githubusercontent.com/linhd-postdata/core-ontology/refs/heads/master/postdata-core.owl) and [analysis](https://raw.githubusercontent.com/linhd-postdata/literaryAnalysis-ontology/refs/heads/master/postdata-literaryAnalysisElements.owl) modules)
- [Schema.org](https://schema.org/)
